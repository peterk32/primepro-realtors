...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Mandela-Max Properties" },
      {
        name: "description",
        content:
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
          <div>
            <SectionHeader
              ...
              subtitle="Mandela-Max Properties began with a simple conviction: that finding a home should feel as considered as the home itself. From our headquarters at Pili Trade Centre, we curate residences and executive suites for a community of clients who notice the details."
            />
