...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — primepro realtors" },
      {
        name: "description",
        content:
           "The story behind primepro realtors: a Nairobi atelier curating boutique luxury properties from our Pili Trade Centre headquarters.",
      },
    ],
  }),
  component: AboutPage,
        ...
        <div className="relative mx-auto grid max-w-7xl gap-16 px-6 lg:grid-cols-2 lg:items-center">
          <div>
            <SectionHeader
              ...
              subtitle="
primepro realtors Kenya began with a simple conviction: that finding a home should feel as considered as the home itself. From our headquarters at Pili Trade Centre, we curate residences and executive suites for a community of clients who notice the details."
            />
